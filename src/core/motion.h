...
namespace librealsense
{
    ...
    // Restored for T265 (TM2). The RS2_EXTENSION_TM2 and RS2_EXTENSION_TM2_SENSOR enum
    // values were never removed from the public API, so re-adding these interfaces does not
    // change the ABI -- it reconnects implementations to enum slots that already exist.
    ...
    public:
        ...
        virtual ~tm2_sensor_interface() = default;
    };
