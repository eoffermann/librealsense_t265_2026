...
namespace librealsense
{
    ...
    // Restored for L500. Removed in 6dba2b2c6 for having no remaining consumers once
    // L500 was gone; L500's depth pipeline chains rotation/confidence transforms and a
    // syncer through it.
